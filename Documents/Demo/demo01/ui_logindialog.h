...
public:
    ...
    void setupUi(QDialog *LoginDialog)
    {
        ...
        lineEdit_3->setGeometry(QRect(200, 310, 361, 41));
        QFont font1;
        ...
        lineEdit_2->setGeometry(QRect(200, 190, 361, 41));
        ...
        label_4->setGeometry(QRect(80, 310, 101, 41));
        ...
        label_6->setGeometry(QRect(30, 410, 151, 41));
        label_6->setFont(font1);
        lineEdit_4 = new QLineEdit(LoginDialog);
        lineEdit_4->setObjectName(QString::fromUtf8("lineEdit_4"));
        lineEdit_4->setGeometry(QRect(200, 410, 361, 41));
